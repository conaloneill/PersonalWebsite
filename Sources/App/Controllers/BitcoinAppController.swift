...
//        
//        let response = req.client.get("https://blockchain.info/tobtc?currency=EUR&value=1")
//        let bitcoinPrice = response.flatMap(file: BitcoinPrice.self) { response in
...
//        let response = req.client.get("https://blockchain.info/ticker")
//        
